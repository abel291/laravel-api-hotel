<div>
            ...
            <x-slot name="content">
                ...
                <div>
                    ...
                    @if ($this->step == 1)
                        ...
                        @include('livewire.reservations.check_1_date')

                    @elseif ($this->step==2)
                        <!--rooms-->

                        @include('livewire.reservations.check_2_room')

                    @elseif ($this->step==3)
                        <!--experiences-->

                        @include('livewire.reservations.check_3_experience')

                    @elseif ($this->step==4)
                        <!--user-->
                        @include('livewire.reservations.check_4_user')


                    @elseif ($this->step==5)

                        @include('livewire.reservations.check_5_confirmation')
    ...
    @include('livewire.reservations.delete-reservations')
    @include('livewire.reservations.details-reservations')
    @push('scripts')
