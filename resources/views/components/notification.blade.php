<div>
    ...
    <div 
        x-data="{ show: false, timeout: null ,title:'',subtitle:'' }"
        @notification.window = "
        show = true;
    ...
    @notification.window=" show = true ; msg = $event.detail " >
        <div class="max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
            ...
            <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                <button type="button" @click="show=false" class="-mr-1 flex p-2 rounded-md hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2">
