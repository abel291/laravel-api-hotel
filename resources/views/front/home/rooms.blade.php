...
<div class="container mx-auto max-w-screen-xl border-b border-gray-200">
    <form action="{{route('reservation.index')}}" class="py-4 text-gray-500 flex space-y-3 xl:space-y-0 flex-wrap ">
        ...
        <div class="w-full md:w-1/2 xl:w-4/12 md:pr-4">
            <div class="flex flex-wrap  border border-gray-300 rounded-md md:divide-x h-full">
                ...
                <div class="w-full  md:w-1/2 py-2 px-4 inline-flex space-x-2 items-center">
                    <span class="font-bold text-gray-500 w-20 md:w-auto">Niños:</span>

                    <select class="focus:outline-none w-16 rounded-md border-gray-300 bg-transparent " name="kids"
                        id="kids">
...
<div class="container mx-auto max-w-screen-xl section-p-y">
    ...
    <div class="grid grid-cols-6 gap-6">
        ...
        <div
            class="col-span-6 md:col-span-3 lg:col-span-2 shadow-md hover:shadow-xl transition-shadow duration-300 rounded-lg overflow-hidden ">
            ...
            <a href="{{route('room',$room->slug)}}">
                ...
                <div class="relative overflow-hidden ">
                    ...
                    <div class="text-white leading-tight space-y-1 py-4 px-4 absolute bottom-0 left-0" title="{{$room->name}}-img">
                        <h3 class="font-semibold text-xl">{{ $room->name }}</h3>
                        <p >
                            <span class="text-2xl font-semibold">${{ $room->price }}.00</span>
                            <span class="text-base font-light">/ noche</span>
                        </p>
                    </div>
                </div>

                <div
                    class="flex flex-wrap py-6 px-4 text-sm text-gray-600 border-gray-200 md:border-none border space-x-4 overflow-hidden">
                    <div class="inline-flex items-center space-x-1 font-semibold">
