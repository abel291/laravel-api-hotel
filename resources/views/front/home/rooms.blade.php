...
@section('content')
    ...
    <div class="container mx-auto max-w-screen-xl border-b border-gray-200">
        <form class="py-4 text-gray-500 flex space-y-3 xl:space-y-0 flex-wrap ">
            ...
            <div class="w-full xl:w-5/12 xl:pr-4 ">
                <div class="flex flex-wrap  border border-gray-300 rounded-md md:divide-x h-full">
                    <div class="w-full  md:w-1/2 py-2 px-4 inline-flex space-x-2 items-center  ">
                        ...
                        <input id="end_date" class="w-32 md:w-full focus:outline-none capitalize bg-transparent " type="text"
                    ...
                    <div class="w-full md:w-1/2  py-2 px-4 inline-flex space-x-2 items-center  ">
                        ...
                        <input id="start_date" class="w-32 md:w-full focus:outline-none capitalize bg-transparent" type="text"
            ...
            <div class="w-full md:w-1/2 xl:w-4/12 md:pr-4">
                <div class="flex flex-wrap  border border-gray-300 rounded-md md:divide-x h-full">
                    ...
                    <div class="w-full  md:w-1/2 py-2 px-4 inline-flex space-x-2 items-center">
                        ...
                        <select class="focus:outline-none w-16 rounded-md border-gray-300 bg-transparent " name="adults" id="adults">
                    ...
                    <div class="w-full  md:w-1/2 py-2 px-4 inline-flex space-x-2 items-center">
                        <span class="font-bold text-gray-500 w-20 md:w-auto">Niñod:</span>

                        <select class="focus:outline-none w-16 rounded-md border-gray-300 bg-transparent " name="adults" id="kids">
                            <option value="1">1 </option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
            ...
            <button class="w-full md:w-1/2 xl:w-3/12  focus:outline-none text-sm h-full py-3 px-5 bg-orange-500 rounded-full text-white font-bold">
        ...
        <div class="grid grid-cols-6 gap-6">
            @foreach ($rooms as $key => $room)
                <div class="col-span-6 md:col-span-3 lg:col-span-2   ">
                    <div class="hover:shadow-xl transition-shadow duration-300 rounded-lg overflow-hidden ">
                        <a href="/room/{{ $room->slug }}" class="block p-3 bg-cover bg-center "
                            style="background-image: linear-gradient(#00000000,#00000040), url(storage/rooms/thumbnail/{{ $room->thumbnail }})">

                            <div class="flex flex-col h-64 justify-between">
                                <div></div>

                                <div class="text-white leading-tight space-y-1">
                        ...
                        <div class="flex p-6 space-x-4 text-gray-400 border-gray-200 md:border-none border ">
