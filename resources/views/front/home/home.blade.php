...
@section('title', 'Hotel Cartagena | Sentirse bien como tu lugar favorito')
...
@section('content')
    ...
    <div class="container section-p-y mx-auto max-w-screen-lg  -mt-20 md:-mt-24">

        <form class="flex flex-col items-center bg-white 
                     rounded-t-xl p-5 overflow-hidden  border-gray-300 border-b  space-y-5 
                     lg:space-y-0 lg:space-x-6 lg:flex-row lg:p-8
                     lg:rounded-lg lg:shadow-xl lg:border-none  ">
    ...
    <div class="container section-p-y mx-auto max-w-screen-lg">

        <div class="space-y-8">
            <div class=" md:w-3/4">
                <span class="tracking-wide md:font-semibold uppercase  text-gray-500 ">Acerca de Nosotros</span>
                <h1 class="text-4xl md:text-5xl font-bold text-gray-800 leading-tight mt-3">Comienza tu asombrosa
                    aventuras. </h1>
            </div>
            ...
            <div class="flex md:flex-row flex-col space-y-5 md:space-y-0 md:space-x-5">
                <p>El clima subtropical húmedo, las altas montañas, la vegetación exótica, las interminables
                    ...
                    festivales
                    de arte y el animado entorno multicultural hacen de Sochi un destino turístico destacado. </p>
    ...
    <div class="container section-p-y mx-auto max-w-screen-lg">
        ...
        <div class="space-y-8">
            <div class="flex justify-between">
                <div>
                    <span class="tracking-wide md:font-semibold uppercase  text-gray-500 ">Habitaciones</span>
                    <h1 class="text-4xl md:text-5xl font-bold text-gray-800 leading-tight mt-3">Habitaciones</h1>
                </div>
                <div class="flex items-end space-x-2 text-gray-800">
            ...
            <div class="flex flex-col lg:flex-row ">
                <div class="w-full lg:w-2/5 z-10 space-y-8 pb-8 lg:pb-8">
                    <div class="text-center lg:text-left">
                        <span class="tracking-wide md:font-semibold uppercase  text-gray-500 ">TESTIMONIOS </span>
                        <h1 class=" text-5xl font-bold text-gray-800 leading-tight mt-3">
                    ...
                    <div id="carousel-list">
                        <div class="swiper-wrapper">
                            ...
                            <div class=" swiper-slide p-8 rounded-md bg-white space-y-5">
                                <h4 class=" text-2xl font-semibold text-gray-800"> Best hotel! </h4>
                                ...
                                <div>
                                    <span class="text-gray-800 font-semibold">Jacob Lane from USA</span>
                                </div>
                            </div>
    ...
    <div class="container section-p-y  mx-auto max-w-screen-lg text-white  -mt-12 md:-mt-20">

        <div
            class="bg-orange-500 py-8 px-8 md:py-16 md:px-10  flex flex-col md:flex-row justify-between items-center rounded-md space-y-3 ">
