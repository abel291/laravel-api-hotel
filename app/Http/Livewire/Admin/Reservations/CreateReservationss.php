...
class CreateReservationss extends Component
{
    ...
    public function check_1_date()
    {
        ...
        $this->step = 2;
        //,string $end_date, int $adults,int $kids,int $night,
        $reservation_system = new ReservationSystem;
        $this->rooms = $reservation_system->check_availability(
            $this->reservation->start_date,
            $this->reservation->end_date,
            $this->adults,
            $this->kids,
            $this->reservation->night
        );
    ...
    public function check_2_room($id_room = null)
    {
        ...
        if ($room) {
            ...
            if ($room->complements->isNotEmpty()) { //no esta vacio
