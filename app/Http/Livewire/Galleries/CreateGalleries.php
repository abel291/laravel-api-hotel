...
class CreateGalleries extends Component
{
    ...
    {
        return view('livewire.galleries.create-galleries');
    }
    ...
    public function upload_images($gallery){
        ...
        foreach ($this->images as $key => $item) {
            ...
            $gallery_name_thumbnail = $gallery_name . '.jpg';
            ...
            Storage::put('galleries/thumbnail/' . $gallery_name_thumbnail, $img_thumbnail->__toString());
