...
/* harmony import */ var fslightbox__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(fslightbox__WEBPACK_IMPORTED_MODULE_2__);



var gallery = document.getElementById('gallery-img');
imagesloaded__WEBPACK_IMPORTED_MODULE_1___default()(gallery, function () {
  // init Isotope after all images have loaded
  var iso = new isotope_layout__WEBPACK_IMPORTED_MODULE_0___default.a(gallery, {
    percentPosition: true,
    itemSelector: '.img-item',
    horizontalOrder: true
  });
  var btn_filter = document.querySelector('.filter-images');
  ...
  if (btn_filter) {
    btn_filter.addEventListener("click", function (e) {
      ...
      var filter_data = e.target.getAttribute('data-filter');
      iso.arrange({
        filter: filter_data
      });
      refreshFsLightbox();
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\jett\resources\js\gallery.js */"./resources/js/gallery.js");
