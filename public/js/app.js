...
/* harmony import */ var flatpickr_dist_l10n_es__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flatpickr/dist/l10n/es */ "./node_modules/flatpickr/dist/l10n/es.js");
/* harmony import */ var flatpickr_dist_l10n_es__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_l10n_es__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/module.esm.js");
/* harmony import */ var _reservation_step_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./reservation_step.js */ "./resources/js/reservation_step.js");
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");



flatpickr__WEBPACK_IMPORTED_MODULE_0__["default"].localize(flatpickr_dist_l10n_es__WEBPACK_IMPORTED_MODULE_1___default.a.es);

window.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_2__["default"];

alpinejs__WEBPACK_IMPORTED_MODULE_2__["default"].data('reservation_step', _reservation_step_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
...
/***/ "./resources/js/reservation_step.js":
/*!******************************************!*\
  !*** ./resources/js/reservation_step.js ***!
  \******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return axios.post('/reservation/step_1_check_date', {
              ...
              case 5:
                ...
                _this.night = response.data.night;
                _this.step = 2;
                _context.next = 14;
                break;
              ...
              case 11:
                ...
                _this.validator_errors(_context.t0);

              case 14:
                _context.prev = 14;
                _this.isLoading = false;

                _this.scroll_top(); //sube el scroll arriba       
    ...
    step_2_select_room: function step_2_select_room(id) {
      var _this2 = this;

      this.room_id = id;
      this.room_quantity = document.getElementById('quantity_availables_' + id).value;
      this.room_selected = this.rooms.find(function (x) {
        return x.id === _this2.room_id;
      });
    ...
    complement_selected: function complement_selected(complement_id, checked) {
      if (checked) {
        this.ids_complements_cheked.push(complement_id);
      } else {
        this.ids_complements_cheked = this.ids_complements_cheked.filter(function (x) {
          return x !== complement_id;
        });
      }
    },
    step_3_confirmation: function step_3_confirmation() {
      var _this3 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return axios.post('/reservation/step_4_confirmation', {
    ...
    step_5_finalize: function step_5_finalize(methodpayment) {
      var _this4 = this;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return axios.post('/reservation/step_5_finalize', {
    ...
    init: function init() {
      ...
      this.$nextTick(function () {
        var calendar_start_date = flatpickr('#step_1_start_date', {
          ...
          altFormat: 'F j, Y',
          dateFormat: 'Y-m-d',
          defaultDate: _this5.start_date,
          minDate: _this5.start_date,
          onClose: function onClose(selectedDates, dateStr, instance) {
            var addDays = selectedDates[0].fp_incr(1);
        ...
        var calendar_end_date = flatpickr('#step_1_end_date', {
          altInput: true,
          altFormat: 'F j, Y',
          dateFormat: 'Y-m-d',
          defaultDate: _this5.end_date,
          minDate: _this5.end_date
        });
        var stripe_id = document.getElementById('card-element').getAttribute('data-stripe_id');

        _this5.init_stripe(stripe_id);
      });
    },
    init_stripe: function init_stripe(stripe_key) {
      var _this6 = this;

      this.$nextTick(function () {
        console.log(_this6.errors.length);
        var style = {
          base: {
            color: '#303238',
            fontSize: '16px',
        ...
        cardButton.addEventListener('click', /*#__PURE__*/function () {
          var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(e) {
            ...
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    _this6.input_stripe_error_name = "";
                    _this6.input_stripe_error_card = "";

                    if (_this6.input_stripe_name) {
                      _context4.next = 6;
                      break;
                    }

                    _this6.input_stripe_error_name = 'El nombre del titular de la targeta es requerido';
                  ...
                  case 9:
                    ...
                    if (error) {
                      _this6.isLoading = false;
                      _this6.input_stripe_error_card = error.message;
                    } else {
                      _this6.step_5_finalize(paymentMethod.id);
    ...
    validator_errors: function validator_errors(errors) {
      if (errors.response.status == 422) {
        ...
        var er = errors.response.data.errors;
...
__webpack_require__(/*! C:\xampp\htdocs\hotel-cartagena\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\xampp\htdocs\hotel-cartagena\resources\css\app.css */"./resources/css/app.css");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\hotel-cartagena\resources\css\front.css */"./resources/css/front.css");
